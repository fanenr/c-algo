...
struct bntree_n *
bntree_insert_left (bntree *restrict tree, struct bntree_n *restrict pos,
...
struct bntree_n *
bntree_insert_right (bntree *restrict tree, struct bntree_n *restrict pos,
                     struct bntree_n *restrict node)
{
  if (pos == NULL)
    {
...
void
bntree_remove (bntree *restrict tree, struct bntree_n *restrict pos)
{
  if (pos == NULL)
    return;
