...
/*
 * free `list`.
 * ensure all nodes of `list` contain a pointer of expr_node and which also
 ...
 * read data from `list` (which should be generated by expr_in2post) and put
 * the result of expression into `result`. if the expression evaluates
 * successfully, the `.type` and `.data` of `result` will be set, otherwise,
 * the `.type` will be set to EXPR_NODE_NONE.
 */
